...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'auxilium', '~> 0.1' # This is our own gem, you must add it to your project's Gemfile for this to work
  ...
  s.add_dependency 'liquor', '~> 0.6' # This is our own gem, you must add it to your project's Gemfile for this to work
