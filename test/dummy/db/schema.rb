...
ActiveRecord::Schema.define(version: 20_190_825_080_757) do
  ...
  create_table 'nuntius_messages', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[nuntiable_type nuntiable_id], name: 'index_nuntius_messages_on_nuntiable_type_and_nuntiable_id'
  ...
  create_table 'nuntius_subscribers', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[nuntiable_type nuntiable_id], name: 'index_nuntius_subscribers_on_nuntiable_type_and_nuntiable_id'
  end
